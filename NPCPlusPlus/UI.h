...
class UI
{
	public:
		...
		static void IntakeAbilityScore(int abilityScoreMin, int abilityScoreMax, int& ability, std::string asPrimeText, std::string asPromptText);

		static void TakeAllAbilityScores(int& str, int& dex, int& con, int& wis, int& intel, int& cha);
